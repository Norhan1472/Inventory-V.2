...
public class ServerController {
    ...
    @GetMapping("getAllServersUp")
    public ResponseEntity<Response>getAllServersUp() throws InterruptedException {
        TimeUnit.SECONDS.sleep(3);
        //throw new InterruptedException("Something went wrong");
        return ResponseEntity.ok(
                Response.builder()
                        ...
                        .httpStatus(OK)
                        .statusCode(OK.value())
                        .data(Map.of("Servers",serverService.getAllServersUp(3000)))
                        .build()
        );
    }
    @GetMapping("getAllServersDown")
    public ResponseEntity<Response>getAllServersDown() throws InterruptedException {
        ...
        return ResponseEntity.ok(
                Response.builder()
                        ...
                        .httpStatus(OK)
                        .statusCode(OK.value())
                        .data(Map.of("Servers",serverService.getAllServersDown(3000)))
                        .build()
        );
    }
